    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Tienda La Caserita Tarija</small></h1>
            </div>
            <p class="lead text-center">
              Crea tu cuenta para comprar en Tienda La Caserita Tarija. Accede a promociones locales, realiza tus pedidos y recibe atención cercana en Tarija y alrededores.
            </p>
            <div class="row">
