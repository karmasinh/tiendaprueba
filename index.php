        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    Ofertas para Tarija y la región
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider2.jpg" alt="slider2">
                <div class="carousel-caption">
                    Electrodomésticos, tecnología y más
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider3.jpg" alt="slider3">
                <div class="carousel-caption">
                    Compra local, apoya Tarija
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Regístrate como cliente de <span class="tittles-pages-logo">Tienda La Caserita Tarija</span> en un sencillo formulario para completar tus pedidos</p>
